        ...
        <>
            ...
            >
                <div className="max-w-6xl mx-auto flex justify-between items-center">
                    ...
                    >
                        {settings?.site_name || "Nama Website"}
                    </motion.div>
            ...
            >
                ...
                >
                    <a
                        href="#about"
                        className="font-medium text-lg hover:text-gray-600 dark:hover:text-gray-400 transition-colors"
                        onClick={() => setIsMobileMenuOpen(false)}
                    >
                        About
                    </a>
                    ...
                    <a
                        href="#contact"
                        className="px-4 py-2 bg-gray-900 dark:bg-gray-100 text-white dark:text-gray-900 rounded text-center font-medium mt-4 hover:opacity-90 transition-opacity"
                        onClick={() => setIsMobileMenuOpen(false)}
                    >
                        Let's talk
                    </a>
