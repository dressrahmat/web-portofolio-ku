import{r as s,j as e}from"./app-celmFoJj.js";const j=s.forwardRef(function({type:l="text",className:n="",isFocused:t=!1,error:c=!1,disabled:x=!1,icon:o=null,onIconClick:u=null,...d},g){const r=s.useRef(null),[p,f]=s.useState(!1);s.useImperativeHandle(g,()=>({focus:()=>r.current?.focus(),blur:()=>r.current?.blur(),value:r.current?.value})),s.useEffect(()=>{t&&r.current?.focus()},[t]);const b=`
